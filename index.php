...
<body>
    <header>
        <div class="d-flex justify-content-between">
           <div class=" logo my-auto ps-3">
             <img src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg" alt="logo">
             <span class="ps-1 fs-5 fw-semibold align-middle">Privacy e termini</span>
           </div>
           <div class="profile">
             <img src="./img/Immagine WhatsApp 2022-12-14 ore 13.07.32.jpg" alt="img">
           </div> 
        </div>
        <nav>
    ...
    <div class="mt-5">
        <?php foreach ( $faqs as $singleFaq ){ ?>
           <?php foreach ( $singleFaq as $valori ){ ?>
                    <?php echo '<p>'.$valori.'</p>'; ?>
                    <?php } ?> 
           <?php } ?>
    </div>
